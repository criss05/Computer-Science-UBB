...
public class StartPageController {
    ...
    public void initialize(){
        ...
        IStatement ex10 = new CompStatement(new VarDeclStatement("v1", new RefType(new IntType())),
                new CompStatement(new VarDeclStatement("v2", new RefType(new IntType())),
                        new CompStatement(new VarDeclStatement("x", new IntType()),
                                new CompStatement(new VarDeclStatement("q", new IntType()),
                                        new CompStatement(new HeapAllocationStatement("v1", new ValueExpression(new IntValue(20))),
                                                new CompStatement(new HeapAllocationStatement("v2", new ValueExpression(new IntValue(30))),
                                                        new CompStatement(new NewLockStatement("x"),
                                                                new CompStatement(
                                                                        new ForkStatement(new CompStatement(
                                                                                new ForkStatement(new CompStatement(new LockStatement("x"),
                                                                                        new CompStatement(new HeapWritingStatement("v1", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v1")), ArithmeticalOperator.SUBTRACT, new ValueExpression(new IntValue(1)))), new UnlockStatement("x")))),
                                                                                new CompStatement(new LockStatement("x"),
                                                                                        new CompStatement(new HeapWritingStatement("v1", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v1")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))), new UnlockStatement("x"))))),
                                                                        new CompStatement(new NewLockStatement("q"),
                                                                                new CompStatement(
                                                                                        new ForkStatement(new CompStatement(
                                                                                                new ForkStatement(new CompStatement(new LockStatement("q"),
                                                                                                        new CompStatement(new HeapWritingStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), ArithmeticalOperator.ADD, new ValueExpression(new IntValue(5)))), new UnlockStatement("q")))),
                                                                                                new CompStatement(new LockStatement("q"),
                                                                                                        new CompStatement(new HeapWritingStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))), new UnlockStatement("q"))))),
                                                                                                                        ...
                                                                                                                        new CompStatement(new LockStatement("x"),
                                                                                                                                new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                                                        new CompStatement(new UnlockStatement("x"),
                                                                                                                                                new CompStatement(new LockStatement("q"),
                                                                                                                                                        new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v2"))), new UnlockStatement("q"))))))))))))))))))));
