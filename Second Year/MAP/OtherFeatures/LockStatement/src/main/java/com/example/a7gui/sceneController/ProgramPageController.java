...
import com.example.a7gui.tableViewModels.LockTableViewModel;
...
public class ProgramPageController {
    @FXML
    public TableView<LockTableViewModel> lockTableView;
    @FXML
    public TableColumn<LockTableViewModel, Integer> locationCol;
    @FXML
    public TableColumn<LockTableViewModel, Integer> valueCol;
    @FXML
    ...
    public void initialize(){
        Platform.runLater(()->{
            ...
            this.valueCol.setCellValueFactory(new PropertyValueFactory<>("Value"));
    ...
    public void update(){
        ...
        this.lockTableView.getItems().setAll(this.currentPrgState.getLockTable().getMap().entrySet().stream().map(e->new LockTableViewModel(e.getKey(), e.getValue())).toList());
    }
