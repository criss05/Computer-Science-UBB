...
public class StartPageController {
    ...
    public void initialize(){
        ...
        IStatement ex10 = new CompStatement(new VarDeclStatement("a", new IntType()),
                new CompStatement(new VarDeclStatement("b", new IntType()),
                        new CompStatement(new VarDeclStatement("c", new IntType()),
                                new CompStatement(new AssignmentStatement("a", new ValueExpression(new IntValue(1))),
                                        new CompStatement(new AssignmentStatement("b", new ValueExpression(new IntValue(2))),
                                                new CompStatement(new AssignmentStatement("c", new ValueExpression(new IntValue(5))),
                                                        new CompStatement(new SwitchStatement(new ArithmeticalExpression(new VariableExpression("a"), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10))),
