                                                ...
                                                new CompStatement(new HeapAllocationStatement("v3", new ValueExpression(new IntValue(4))),
                                                        new CompStatement(new VarDeclStatement("cnt", new IntType()),
                                                                new CompStatement(new NewLatchStatement("cnt", new ReadHeapExpression(new VariableExpression("v2"))),
                                                                        new CompStatement(new ForkStatement(new CompStatement(new HeapWritingStatement("v1", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v1")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))),
                                                                                                                        new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v1"))),
                                                                                                                                new CompStatement(new CountDownStatement("cnt"),
                                                                                                                                        new ForkStatement(new CompStatement(new HeapWritingStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))),
                                                                                                                                                                                new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v2"))),
                                                                                                                                                                                        new CompStatement(new CountDownStatement("cnt"),
                                                                                                                                                                                                new ForkStatement(new CompStatement(new HeapWritingStatement("v3", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v3")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))),
                                                                                                                                                                                                        new CompStatement(new PrintStatement(new ReadHeapExpression(new VariableExpression("v3"))),new CountDownStatement("cnt")))))))))))),
