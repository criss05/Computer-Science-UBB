...
import com.example.a7gui.tableViewModels.LatchTableViewModel;
...
public class ProgramPageController {
    @FXML
    public TableView<LatchTableViewModel> latchTableView;
    @FXML
    public TableColumn<LatchTableViewModel, Integer> locationLatchCol;
    @FXML
    public TableColumn<LatchTableViewModel, Integer> valueLatchCol;
    @FXML
    ...
    public void initialize(){
        Platform.runLater(()->{
            ...
            this.locationLatchCol.setCellValueFactory(new PropertyValueFactory<>("Location"));
            this.valueLatchCol.setCellValueFactory(new PropertyValueFactory<>("Value"));
    ...
    public void update(){
        ...
        this.latchTableView.getItems().setAll(this.currentPrgState.getLatchTable().getMap().entrySet().stream().map(e->new LatchTableViewModel(e.getKey(), e.getValue())).toList());
        this.symTableView.getItems().setAll(this.currentPrgState.getSymTable().getMap().entrySet().stream().map(e-> new SymTableViewModel(e.getKey(), e.getValue())).toList());
