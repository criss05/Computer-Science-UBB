...
public class StartPageController {
    ...
    public void initialize(){
        ...
        IStatement ex10 = new CompStatement(new VarDeclStatement("v", new IntType()),
                new CompStatement(new AssignmentStatement("v", new ValueExpression(new IntValue(20))),
                        new CompStatement(new WaitStatement(10), new PrintStatement(new ArithmeticalExpression(new VariableExpression("v"), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))))));
