        ...
        IStatement ex10 = new CompStatement(new VarDeclStatement("v", new IntType()),
                new CompStatement(new VarDeclStatement("w", new IntType()),
                        new CompStatement(new AssignmentStatement("v", new ValueExpression(new IntValue(2))),
                                new CompStatement(new AssignmentStatement("w", new ValueExpression(new IntValue(5))),
                                        new CompStatement(new CallFnameStatement(new ArrayList<>(Arrays.asList(new ArithmeticalExpression(new VariableExpression("v"), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10))), new VariableExpression("w"))),"sum"),
                                                new CompStatement(new PrintStatement(new VariableExpression("v")),
                                                        new ForkStatement(new CompStatement(new CallFnameStatement(new ArrayList<>(Arrays.asList(new VariableExpression("v"), new VariableExpression("w"))), "product"),
                                                                                                new ForkStatement(new CallFnameStatement(new ArrayList<>(Arrays.asList(new VariableExpression("v"), new VariableExpression("w"))), "sum"))))))))));
