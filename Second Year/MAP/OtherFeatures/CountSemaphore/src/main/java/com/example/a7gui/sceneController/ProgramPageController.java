...
import com.example.a7gui.tableViewModels.SemaphoreTableViewModel;
...
public class ProgramPageController {
    @FXML
    public TableView<SemaphoreTableViewModel> semTableView;
    @FXML
    public TableColumn<SemaphoreTableViewModel, Integer> semIndexCol;
    @FXML
    public TableColumn<SemaphoreTableViewModel, Integer> semValueCol;
    @FXML
    public TableColumn<SemaphoreTableViewModel, List<Integer>> semListCol;
    @FXML
    ...
    public void initialize(){
        Platform.runLater(()->{
            ...
            this.semIndexCol.setCellValueFactory(new PropertyValueFactory<>("Index"));
            this.semValueCol.setCellValueFactory(new PropertyValueFactory<>("Value"));
            this.semListCol.setCellValueFactory(new PropertyValueFactory<>("List"));
    ...
    public void update(){
        ...
        this.semTableView.getItems().setAll(this.currentPrgState.getSemTable().getMap().entrySet().stream().map(e->new SemaphoreTableViewModel(e.getKey(), e.getValue().getKey(), e.getValue().getValue())).toList());
    }
