...
import com.example.a7gui.tableViewModels.BarrierTableViewModel;
...
public class ProgramPageController {
    @FXML
    public TableView<BarrierTableViewModel> barrierTableView;
    @FXML
    public TableColumn<BarrierTableViewModel, Integer> barrierIndexCol;
    @FXML
    public TableColumn<BarrierTableViewModel, Integer> barrierValueCol;
    @FXML
    public TableColumn<BarrierTableViewModel, List<Integer>> barrierListCol;
    @FXML
    ...
    public void initialize(){
        Platform.runLater(()->{
            ...
            this.barrierIndexCol.setCellValueFactory(new PropertyValueFactory<>("BarrierIndex"));
            this.barrierValueCol.setCellValueFactory(new PropertyValueFactory<>("BarrierValue"));
            this.barrierListCol.setCellValueFactory(new PropertyValueFactory<>("BarrierList"));
    ...
    public void update(){
        ...
        this.barrierTableView.getItems().setAll(this.currentPrgState.getBarrierTable().getMap().entrySet().stream().map(e-> new BarrierTableViewModel(e.getKey(), e.getValue().getKey(), e.getValue().getValue())).toList());
        this.symTableView.getItems().setAll(this.currentPrgState.getSymTable().getMap().entrySet().stream().map(e-> new SymTableViewModel(e.getKey(), e.getValue())).toList());
