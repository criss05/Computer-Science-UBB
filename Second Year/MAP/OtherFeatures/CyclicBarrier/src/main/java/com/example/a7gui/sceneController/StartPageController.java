                                        ...
                                        new CompStatement(new HeapAllocationStatement("v1", new ValueExpression(new IntValue(2))),
                                                new CompStatement(new HeapAllocationStatement("v2", new ValueExpression(new IntValue(3))),
                                                        new CompStatement(new HeapAllocationStatement("v3", new ValueExpression(new IntValue(4))),
                                                                new CompStatement(new NewBarrierStatement("cnt", new ReadHeapExpression(new VariableExpression("v2"))),
                                                                        new CompStatement(new ForkStatement(new CompStatement(new AwaitStatement("cnt"),
                                                                                new CompStatement(new HeapWritingStatement("v1", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v1")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))), new PrintStatement(new ReadHeapExpression(new VariableExpression("v1")))))),
                                                                                new CompStatement(new ForkStatement(new CompStatement(new AwaitStatement("cnt"),
                                                                                        new CompStatement(new HeapWritingStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))),
                                                                                                new CompStatement(new HeapWritingStatement("v2", new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("v2")), ArithmeticalOperator.MULTIPLY, new ValueExpression(new IntValue(10)))), new PrintStatement(new ReadHeapExpression(new VariableExpression("v2"))))))),
                                                                                        new CompStatement(new AwaitStatement("cnt"), new PrintStatement(new ReadHeapExpression(new VariableExpression("v3"))))))))))))));
