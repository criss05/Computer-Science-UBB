                                        ...
                                        new CompStatement(new HeapAllocationStatement("b", new ValueExpression(new IntValue(0))),
                                                new CompStatement(new HeapWritingStatement("a", new ValueExpression(new IntValue(1))),
                                                        new CompStatement(new HeapWritingStatement("b", new ValueExpression(new IntValue(2))),
                                                                new CompStatement(new ConditionalAssigmentStatement("v", new RelationalExpression(new ReadHeapExpression(new VariableExpression("a")), RelationalOperator.LESS, new ReadHeapExpression(new VariableExpression("b"))),
                                                                        ...
                                                                        new CompStatement(new PrintStatement(new VariableExpression("v")),
                                                                                new CompStatement(new ConditionalAssigmentStatement("v", new RelationalExpression(new ArithmeticalExpression(new ReadHeapExpression(new VariableExpression("b")),ArithmeticalOperator.SUBTRACT, new ValueExpression(new IntValue(2))), RelationalOperator.GRATER, new ReadHeapExpression(new VariableExpression("a"))),
                                                                                                        new ValueExpression(new IntValue(100)), new ValueExpression(new IntValue(200))),
