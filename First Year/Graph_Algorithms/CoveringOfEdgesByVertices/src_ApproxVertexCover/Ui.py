from Graph_Algorithms.CoveringOfEdgesByVertices.src_ApproxVertexCover.Graph import Graph
import random
...
class UI:
    ...
    def cover_edges(self):
        cover = self.__graph.edge_cover_aprox()
        print("The vertices in the edge cover are: ", cover)
