from Graph_Algorithms.CoveringOfEdgesByVertices.src_BranchAndBoundAlgorithm.Graph import Graph
import random
...
class UI:
    ...
    def cover_edges(self):
        cover_branch = self.__graph.edge_cover_branch_and_bound()
        print("Cover edges by vertices is: ", cover_branch)
