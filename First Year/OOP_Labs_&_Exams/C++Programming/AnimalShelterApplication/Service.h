...
public:
	...
	//Output: the service
	Service(ClientRepository client_repo, EmployeesRepository employees_repo);
	...
	Pet* GetYoungDogsOfGivenBreed(std::string given_breed, int given_age, int& number_elements);
