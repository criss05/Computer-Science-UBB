...
import random
# TODO 2 formats for read and write
...
class UI:
    ...
    def print_menu():
        print("0. Read the graph from file\n"
              ...
              "20. Find the minimum cost path between two vertices.\n"
              "21. Exit.\n")
    ...
    def find_min_cost(self):
        ...
        min_cost, min_cost_path = self.__graph.find_min_cost_path(int(vertex1), int(vertex2))
        if min_cost == float("inf"):
            print(f"There is no path between {vertex1} and {vertex2}")
        else:
            print(f"The minimum cost path between {vertex1} and {vertex2} is: {min_cost}")
            print("The path is: ")
