from Graph_Algorithms.CoveringOfEdgesByVertices.src_CleverGreedyAlgorithm.Graph import Graph
import random
...
class UI:
    ...
    def cover_edges(self):
        cover_greedy = self.__graph.edge_cover_greedy()
        print("Greedy: ", cover_greedy)
